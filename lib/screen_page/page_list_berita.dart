import 'package:coba2/screen_page/page_detail_berita.dart';
import 'package:coba2/screen_page/page_login_api.dart';
...
class _PageListBeritaState extends State<PageListBerita> {
  ...
  Future<List<Datum>?> getBerita() async{
    try{
      ...
      http.get(Uri.parse("http://10.126.68.85/beritaDb/getBerita.php"));
                        ...
                        children: [
                          Padding(padding: EdgeInsets.all(4),
                            child: ClipRRect(
                              ...
                              child: Image.network('http://10.126.68.85/beritaDb/gambar_berita/${data?.gambarBerita}',
                                fit: BoxFit.fill,
                              ),
                            ),
                          ),
